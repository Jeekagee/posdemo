                    ...
                    <div class="form-panel" style="padding:25px">
                      <div id="delete_msg">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                            <input type="text" value="<?php echo $items->barcode; ?>" class="form-control" name="barcode" id="barcode" readonly>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                            <input type="text" value="<?php echo $items->item_id; ?>" class="form-control" name="item_id" id="item_id" readonly>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                            <input type="text" value="<?php echo $items->item_name; ?>" class="form-control" name="item_name" id="item_name" readonly>
                        ...
                        <input type="text" value="<?php echo $items->item_id; ?>" name="item_id" hidden>

                        <div class="form-group">
                          <div class="col-sm-3"></div>
                          <div class="col-sm-8">
                            <input type="submit" class="btn btn-success pull-right mr-5" value="Update">
                            <a style="margin-right: 15px;" href="<?php echo base_url(); ?>Inventory/Items" class="pull-right btn btn-danger">Cancel</a>
                          </div>
                        </div>
