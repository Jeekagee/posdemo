                ...
                <div class="form-panel">
                    <div class="row">
                            ...
                            <div style="margin-top:10px;">
                                <div class="row fnt-15 fnt-bold">
                                    <div class="col-xs-3 col-md-6 col-lg-3">
                                        <a class="btn btn-order btn-wt-100"
                                            onclick="clear_items(<?php echo $order_id; ?>)">Clear</a>
                                    </div>
                                    <div class="col-xs-3 col-md-6 col-lg-3">
                                        <button type="button" class="btn btn-order btn-wt-100" data-toggle="modal"
                                            data-target="#discount">Discount</button>
                                    </div>
                                    <div class="col-xs-3 col-md-6 col-lg-3">
                                        <a class="btn btn-order btn-wt-100"
                                            href="<?php echo base_url(); ?>Orders/hold_order/<?php echo $order_id; ?>">Hold</a>
                                    </div>
                                    <div class="col-xs-3 col-md-6 col-lg-3">
                                        <button type="button" class="btn btn-order btn-wt-100" data-toggle="modal"
                        ...
                        <div class="col-md-8">
                            <div class="row">
                                <div class="col-md-3">
                                    <a href="<?php echo base_url(); ?>Orders/hold_orders"
                                        class="btn btn-primary btn_item">Hold Orders <span
                                            class="badge bg-warning"><?php echo $CI->Orders_model->hold_order_count(); ?></span></a>
                                </div>
                                <div class="col-md-2">
                                    <a class="btn btn-primary btn_item" data-toggle="modal"
                                        data-target="#add_customer">Customer</a>
                                </div>
                                ...
                                <div class="col-md-2">
                                    <a class="btn btn-primary btn_item" id="clear_btn"
                                        onclick="clear_search()">Clear</a>
                                </div>
                            </div>
                          ...
                          ?>
                                ...
                                <?php echo $item_id = $itm->item_id; ?>
                                            ...
                                            <div class="item_m fnt-bold" style="color:#313552;">
                                                ...
                                                <?php echo $CI->Orders_model->selling_price($item_id, $var_id); ?>
                                            </div>
                                            <div class="item_m">
                                                Qty : <?php echo $itm->qty; ?><br>
                                                Purchase price:
                                                <?php echo $CI->Orders_model->purchase_price($item_id, $var_id); ?>
                                            </div>
                                        </div>
                                    </div>
                                </a>

                                <input hidden type="text" id="id<?php echo $int_qty_id; ?>"
                                    value="<?php echo $int_qty_id; ?>">
                                <input hidden type="text" id="order_id<?php echo $int_qty_id; ?>"
                                ...
                                $(document).ready(function() {
                                    $("#single_hold_item<?php echo $int_qty_id; ?>").click(function() {
                                        ...
                                        $.ajax({
                                            url: "<?php echo base_url(); ?>Orders/update_pay_model",
                                            type: "POST",
                                            cache: false,
                                            data: {
                                                order_id: order_id
...
<?php
$order_data = $CI->Orders_model->order_tbl_data($order_id);
...
$(document).ready(function() {
    ...
    $("#add_customer").submit(function() {
        ...
        if (mobile == "" || name == "") {
            $("#validation").html(
                "<div class='alert alert-danger'>Mobile number and Customer name is Requested</div>"
            );
            return false;
        } else {
            if (mobile.length == 10) {
                ...
                $("#validation").html(
                    "<div class='alert alert-warning'>Please Enter a Valid Number (0771234567)</div>"
                );
                return false;
            }
        }
